...
<h2>Exercice 14</h2>
<form action="" method="" name="exo14">
    <label>Notez quelque chose</label>
    <input id="text" type="text" id="text"/>
    <input onclick="fctSubmit()" id="submit" type="submit" value="Ok"/>
    <input onclick="remise_a_zero()" id="reset" type="reset" value="reset"/>
</form>
</body>
